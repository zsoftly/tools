...
function Get-AuthKey {
    ...
    Write-Host "The key determines your access level:"
    Write-Host "  - employee-std:    Non-production access"
    Write-Host "  - employee-senior: Non-production + Production access"
    Write-Host ""
    Write-Host "If you don't have a key, you can still connect via SSO (browser)"
    Write-Host "but you'll need an admin to assign tags after registration."
    Write-Host ""
